...
import { Home, Mail, Settings, Book, Bell, Clipboard, FileText, CheckCircle, Award } from "lucide-react";
      ...
      <header className="w-full border-b shadow-sm">
        <div className="flex items-center justify-between px-8 py-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button variant="ghost" onClick={() => router.push("/messages")} className="flex items-center space-x-2">
              <Mail className="w-5 h-5" />
              <span>Messages</span>
            </Button>
            <Button variant="ghost" onClick={() => router.push("/settings")} className="flex items-center space-x-2">
                    ...
                    {[1, 2, 3, 4, 5].map((lesson) => (
                      <div key={lesson} className="flex justify-between items-center">
                        <div>
                          ...
                          <p className="text-sm">Instructor: Professor {lesson}</p>
                        </div>
