    ...
    <div className="min-h-screen bg-gradient-to-r">
      <header className="container mx-auto py-4 bg-slate-200 dark:bg-black">
        <nav className="flex justify-between items-center">
          <h1 className="text-lg font-bold ml-5 cursor-default dark:hover:text-gray-300 hover:text-gray-700 transition-all sm:text-2xl">EduConnect</h1>
      ...
      <main className="container mx-auto px-4">
        <section className="text-center py-20">
          <h2 className="text-2xl font-bold mb-5">
            <div className=" bg-gradient-to-r to-danger bg-clip-text text-transparent from-blue-600 via-blue-500 to-blue-600 font-semibold">Seamless Communication</div> for Schools, Teachers, and Students
          </h2>
          ...
          <Button className="px-8 py-4 text-sm hover:bg-blue-500 hover:text-white hover:px-9 transition-all">Get Started</Button>
        </section>

        <section className="py-20">
          <h1 className="text-center text-xl mb-5 font-semibold hover:text-blue-500 transition-all cursor-default">Features</h1>
